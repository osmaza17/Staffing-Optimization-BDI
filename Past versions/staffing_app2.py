...
class StaffingApp:
    def __init__(self):
        ...
        # Diccionario para navegación por teclado en la matriz R
        self.r_cells = {}
        ...
        # Padding added here to avoid scrollbar overlap
    ...
    def main(self, page: ft.Page):
        ...
        # Increased height for text fields to 300
        ...
        people_task_row = ft.Row(
            controls=[
                ft.Container(
                    width=180, height=250, # Increased Height
                    content=ft.Column([
                        ft.Text("1. People", color=self.COLOR_TEXT_HIGHLIGHT, weight="bold", size=12),
                        ft.Container(
                ...
                ft.Container(
                    width=180, height=250, # Increased Height
                    content=ft.Column([
                        ft.Text("2. Tasks", color=self.COLOR_TEXT_HIGHLIGHT, weight="bold", size=12),
                        ft.Container(
        ...
        config_below = ft.Column([
            ft.Text("3. Active Hours", color=self.COLOR_TEXT_HIGHLIGHT, weight="bold", size=12),
            ft.Container(
            ...
            ft.Text("4. Parameters", color=self.COLOR_TEXT_HIGHLIGHT, weight="bold", size=12),
        ...
        # Padding added to the container holding the matrices to prevent scrollbar overlap
        matrices_wrapper = ft.Container(
            content=self.content_matrices,
            padding=ft.padding.only(right=25, bottom=25, left=10), 
        )

        # === MASTER SCROLL LAYOUT ===
        # Strategy:
        # Row (Horizontal Outer) -> Expand=True means it sticks to bottom.
        # Column (Vertical Inner) -> Expand=True means it sticks to right.
        # This combination ensures the horizontal bar is always visible at the bottom of the Tab.
            ...
            content=ft.Row(
                controls=[
                    ft.Column(
                        ...
                        scroll=ft.ScrollMode.ALWAYS, # Vertical Scroll on the inner content
                        expand=True 
                    )
                ],
                scroll=ft.ScrollMode.ALWAYS, # Horizontal Scroll on the outer container
                expand=True,
        ...
        self.tabs_control = ft.Tabs(
            ...
            tabs=[
                ...
                ft.Tab(text="2. Mandatory/Fixed", content=ft.Container(content=self.content_mandatory, padding=10)),
            ]
        )
    ...
    def _update_single_cell(self, control, tipo, k1, k2, k3, force_val=None):
        ...
        if force_val is not None:
            ...
            if tipo == 'D': current_val = self.state_D.get(k1, {}).get(k2, 1) # Safer get
    ...
    def execute_bulk_action(self, action_type, matrix_type, key):
        ...
        # Check current state of first element to toggle
        current_val = 1 
        if action_type == 'row':
    ...
    def generate_tables(self):
        ...
        # IMPORTANT: Reset control references on regeneration
        self.grid_controls = {'D': {}, 'Q': {}}
        self.r_cells = {} 
