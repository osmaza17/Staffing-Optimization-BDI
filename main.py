...
def solve_model(data):
    """
    Construye modelo con IDs seguros y resuelve usando CBC o Highs según selección.
    """
    ...
    # Esto beneficia a ambos solvers
    ...
    # =========================================================
    # LÓGICA DE EJECUCIÓN (BIFURCACIÓN)
    # =========================================================
    
    # --- OPCIÓN A: CBC (PULP STANDARD) ---
    if solver_type == 'cbc':
